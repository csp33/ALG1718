...
*/
static void mergesort_lims(int T[], int inicial, int final, const int UMBRAL_MS);
...
int main(int argc, char * argv[])
{
	...
	if (argc != 3)
	{
		cerr << "Formato " << argv[0] << " <umbral> <num_elem>" << endl;
		return -1;
	}
	...
	tdespues = clock();
	cout << UMBRAL_MS << "\t" << ((double)(tdespues - tantes))
	     / CLOCKS_PER_SEC << endl;
